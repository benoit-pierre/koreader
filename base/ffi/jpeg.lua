...
-- The turbojpeg library symbols are versionned,
-- so it should always be backward compatible:
-- the major & patch numbers are always 0, and
-- when a new API version if made avaible, the
