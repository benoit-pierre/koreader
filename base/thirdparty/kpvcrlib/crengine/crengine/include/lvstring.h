...
/// memcpy for lChar32
inline void lStr_memcpy(lChar32 * __restrict__ dst, const lChar32 * __restrict__ src, int count) {
...
/// memmove for lChar32
inline void lStr_memmove(lChar32 * dst, const lChar32 * src, int count) {
...
inline void _concat(lChar32 *p, const int *size, const T &t) {
    _concat_cpy(p, *size, t);
}
template<typename T, typename... Args>
inline void _concat(lChar32 *p, const int *size, const T &t, const Args &... args) {
    _concat_cpy(p, *size, t);
