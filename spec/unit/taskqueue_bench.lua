...
describe("taskqueue benchmark:", function()

    local UIManager = require("ui/uimanager")

    it("simple checkTasks and scheduling benchmark", function()
        local now = time.now()
    ...
    it("more advanced checkTasks and scheduling benchmark", function()
