...
describe("UIManager benchmark:", function()

    it("checkTasks", function()
        local now = time.now()
    ...
    it("sophisticated schedule", function()
    ...
    it("schedule massive collision tests", function()
    ...
    it("schedule massive ridiculous tests", function()
