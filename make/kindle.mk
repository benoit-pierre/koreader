...
update: all
	...
	# create new package
	cd $(INSTALL_DIR) && \
	    zip -9 -r ../$(KINDLE_PACKAGE) extensions koreader \
	    $(KINDLE_LEGACY_LAUNCHER) -x $(release_excludes)
	# generate kindleupdate package index file
	zipinfo -1 $(KINDLE_PACKAGE) >$(INSTALL_DIR)/koreader/ota/package.index
	...
	cd $(INSTALL_DIR) && zip -u ../$(KINDLE_PACKAGE) koreader/ota/package.index
