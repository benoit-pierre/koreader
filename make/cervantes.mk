...
update: all
	...
	# create new package
	cd $(INSTALL_DIR) && zip -9 -r ../$(CERVANTES_PACKAGE) koreader -x $(release_excludes)
	# generate update package index file
	zipinfo -1 $(CERVANTES_PACKAGE) >$(INSTALL_DIR)/koreader/ota/package.index
	...
	cd $(INSTALL_DIR) && zip -u ../$(CERVANTES_PACKAGE) koreader/ota/package.index
